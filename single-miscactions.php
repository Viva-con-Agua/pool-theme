<?php
/**
 * The Template for displaying single miscellaneous activities (of the actions department).
 */
...
if ( have_posts() ) while ( have_posts() ) : the_post();
		...
		$output .= '<div class="activity single-activity">' .
			...
			'<img class="activity-icon" alt="' . __( 'miscellaneous activity', 'vca-theme' ) . '" src="' . get_bloginfo( 'template_url' ) . '/images/icons/icon-miscactions_32.png" />' .

			'<h4>' . get_the_title() . '</h4>' .

			'<h5>' . __( 'The miscellaneous activity', 'vca-theme' ) . '</h5>' .
