...
if ( have_posts() ) while ( have_posts() ) : the_post();
		...
		$output .= '<div class="activity single-activity">' .
			...
			'<img class="activity-icon" alt="' . __( 'Network Gathering', 'vca-theme' ) . '" src="' . get_bloginfo( 'template_url' ) . '/images/icons/icon-nwgathering_32.png" />' .

			'<h4>' . get_the_title() . '</h4>' .

			'<h5>' . __( 'The Network Gathering', 'vca-theme' ) . '</h5>' .
