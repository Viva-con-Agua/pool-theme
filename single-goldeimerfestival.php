<?php
/**
 * The Template for displaying single Network Gatherings.
 */
...
if ( have_posts() ) while ( have_posts() ) : the_post();
		...
		$output .= '<div class="activity activity-goldeimerfestival single-activity">' .

			'<img class="activity-icon" alt="' . __( 'Goldeimer Festival', 'vca-theme' ) . '" src="' . get_bloginfo( 'template_url' ) . '/images/icons/icon-goldeimer_32.png" />' .

			'<h4>' . get_the_title() . '</h4>' .

			'<h5>' . __( 'The Festival', 'vca-theme' ) . '</h5>' .
